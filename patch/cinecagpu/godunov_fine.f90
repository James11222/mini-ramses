...
!     write(*,'(" STAMPA QUI IL VALORE DEL SUPEROCT",I4)')m%grid(igrid)%superoct
...
subroutine godfine1(s,ind_grid,ilevel,h)
  ...
  call nvtxStartRange("godfine1",0)
...
#endif
        do i1=ii1min,ii1max
!           write(*,'("INDICI K",2I4)')kk1min,kk1max
!           write(*,'("INDICI J",2I4)')jj1min,jj1max
!           write(*,'("INDICI I",2I4)')ii1min,ii1max
!           write(*,'("##############")')
  ...
  call nvtxStartRange("call unsplit", 5)
  !-----------------------------------------------
 ...
 call nvtxStartRange("godunov_fine loops", 2)
 ...
 call nvtxStartRange("godunov_fine loops over inner octs", 10)
  do idim=1,ndim
     i0=0; j0=0; k0=0
     ii0=0; jj0=0; kk0=0
     if(idim==1)i0=1
...
call nvtxEndRange()
 ...
 call nvtxStartRange("godunov_fine loops over dimensions", 13)
...
call nvtxEndRange()
 ...
 call nvtxStartRange("godunov_fine loops over outer octs right face", 14)
...
call nvtxEndRange()
  ...
  call nvtxStartRange("godunov_fine unlock all octs", 15)
