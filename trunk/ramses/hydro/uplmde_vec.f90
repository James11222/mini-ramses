...
!###########################################################
!###########################################################
subroutine tracex_vec(q,dq,c,qm,qp,dx,dt,ngrid)
  use amr_parameters
...
end subroutine tracex_vec
!###########################################################
!###########################################################
!###########################################################
!###########################################################
#if NDIM>1
subroutine tracexy_vec(q,dq,c,qm,qp,dx,dy,dt,ngrid)
  use amr_parameters
  use hydro_parameters
  use hydro_vec_parameters
  use const
...
!###########################################################
#if NDIM>2
subroutine tracexyz_vec(q,dq,c,qm,qp,dx,dy,dz,dt,ngrid)
  use amr_parameters
  use hydro_parameters
  use hydro_vec_parameters
  use const
...
end subroutine tracexyz_vec
#endif
!###########################################################
!###########################################################
!###########################################################
!###########################################################
subroutine cmpdivu_vec(q,div,dx,dy,dz,ngrid)
  use amr_parameters
  use hydro_parameters
  use hydro_vec_parameters
  use const
...
end subroutine cmpdivu_vec
!###########################################################
!###########################################################
!###########################################################
!###########################################################
subroutine consup_vec(uin,flux,div,dt,ngrid)
  use amr_parameters
  use hydro_parameters
  use hydro_vec_parameters
  use const
