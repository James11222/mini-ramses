...
!###########################################################
!###########################################################
subroutine interpol_hydro_vec(u1,u2,nn)
  use amr_commons
  use hydro_commons
  use poisson_commons
  implicit none
  ...
  do ivar=1,nvar
     ...
     if(interpol_type==1)call compute_limiter_minmod_vec(a,w,nn)
     if(interpol_type==2)call compute_limiter_central_vec(a,w,nn)
     if(interpol_type==3)call compute_central_vec(a,w,nn)
     ...
     if(interpol_type==4)then
        ...
        if (ivar>1 .and. (ivar <= 1+ndim))then
           call compute_central_vec(a,w,nn)
        else
           call compute_limiter_central_vec(a,w,nn)
        end if
     end if
...
end subroutine interpol_hydro_vec
!###########################################################
!###########################################################
!###########################################################
!###########################################################
subroutine compute_limiter_minmod_vec(a,w,nn)
  use amr_commons
  use hydro_commons
  implicit none
  integer::nn
...
end subroutine compute_limiter_minmod_vec
!###########################################################
!###########################################################
!###########################################################
!###########################################################
subroutine compute_limiter_central_vec(a,w,nn)
  use amr_commons
  use hydro_commons
  implicit none
  integer::nn
...
end subroutine compute_limiter_central_vec
!###########################################################
!###########################################################
!###########################################################
!###########################################################
subroutine compute_central_vec(a,w,nn)
  use amr_commons
  use hydro_commons
  implicit none
  integer::nn
...
end subroutine compute_central_vec
